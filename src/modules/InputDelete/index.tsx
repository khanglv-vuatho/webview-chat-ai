...
export function PlaceholdersAndVanishInput({
  ...
  return (
    ...
    >
      <canvas
        className={cn(
          'pointer-events-none absolute left-2 top-[20%] origin-top-left scale-50 transform pr-20 text-base opacity-100 invert filter dark:invert-0 sm:left-8',
...
export function PlaceholdersAndVanishInputDemo() {
  ...
  return (
    <div className='flex w-full flex-col items-center justify-center bg-red-200 px-4'>
